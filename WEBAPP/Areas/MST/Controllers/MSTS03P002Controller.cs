...
{
    public class MSTS03P002Controller : MSTBaseController
    {
        #region Property
        private MSTS03P002Model localModel = new MSTS03P002Model();
        private MSTS03P002Model TempModel
        {
            get
            {
                if (TempData["Model" + SessionHelper.SYS_CurrentAreaController] == null)
                {
                    TempData["Model" + SessionHelper.SYS_CurrentAreaController] = new MSTS03P002Model();
                }
                TempData.Keep("Model" + SessionHelper.SYS_CurrentAreaController);
                return TempData["Model" + SessionHelper.SYS_CurrentAreaController] as MSTS03P002Model;
            }
            set
            {
        ...
        private MSTS03P002Model TempSearch
        {
            get
            {
                if (TempData[StandardActionName.Search + SessionHelper.SYS_CurrentAreaController] == null)
                {
                    TempData[StandardActionName.Search + SessionHelper.SYS_CurrentAreaController] = new MSTS03P002Model();
                }
                TempData.Keep(StandardActionName.Search + SessionHelper.SYS_CurrentAreaController);

                return TempData[StandardActionName.Search + SessionHelper.SYS_CurrentAreaController] as MSTS03P002Model;
            }
        ...
        public ActionResult Search(MSTS03P002Model model)
        {
            var da = new MSTS03P002DA();
            SetStandardErrorLog(da.DTO);
            da.DTO.Execute.ExecuteType = MSTS03P002ExecuteType.GetAll;
        ...
        [HttpPost]
        public ActionResult DeleteSearch(List<MSTS03P002Model> data)
        {
        ...
        public ActionResult SaveCreate(MSTS03P002Model model)
        {
            var jsonResult = new JsonResult();
        ...
        public ActionResult Edit(MSTS03P002Model model)
        {
            var da = new MSTS03P002DA();
            SetStandardErrorLog(da.DTO);
            da.DTO.Execute.ExecuteType = MSTS03P002ExecuteType.GetByID;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult SaveModify(MSTS03P002Model model)
        {
            var jsonResult = new JsonResult();
            if (ModelState.IsValid)
            {
        ...
        public ActionResult BindPriority(string APP_CODE)
        {
            var model = GetDDLCenter(DDLCenterKey.DD_MSTS03P002_001, new VSMParameter(APP_CODE.Trim()));
        ...
        private DTOResult SaveData(string mode, object model)
        {
            ...
            if (mode == StandardActionName.SaveCreate)
            {
                ...
                da.DTO.Model = (MSTS03P002Model)model;
                da.DTO.Execute.ExecuteType = MSTS03P002ExecuteType.Insert;
            ...
            {
                SetStandardField(model);
                da.DTO.Execute.ExecuteType = MSTS03P002ExecuteType.Update;
                da.DTO.Model = (MSTS03P002Model)model;
            ...
            {
                da.DTO.Models = (List<MSTS03P002Model>)model;
                da.DTO.Model.COM_CODE = SessionHelper.SYS_COM_CODE;
